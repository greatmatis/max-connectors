...
Плагин для Figma, который быстро соединяет два выделенных объекта стилизованным коннектором.
...
Обе команды доступны через Quick Actions в Figma (⌘/).
...
1. Создайте коннектор в Figma и назовите его `Master Connector`
...
Скомпилированный файл — `code.js`. Загрузите плагин в Figma через Plugins > Development > Import plugin from manifest.
